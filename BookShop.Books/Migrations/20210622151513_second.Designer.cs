...
namespace BookShop.Books.Migrations
{
    ...
    [Migration("20210622151513_second")]
            ...
            modelBuilder.Entity("BookShop.Domain.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2021, 6, 22, 18, 15, 9, 13, DateTimeKind.Local).AddTicks(6679),
            ...
            modelBuilder.Entity("BookShop.Domain.Entities.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AuthorId = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2021, 6, 22, 18, 15, 9, 19, DateTimeKind.Local).AddTicks(1162),
            ...
            modelBuilder.Entity("BookShop.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2021, 6, 22, 18, 15, 9, 18, DateTimeKind.Local).AddTicks(8649),
                            Name = "Literature"
                        });
                });
